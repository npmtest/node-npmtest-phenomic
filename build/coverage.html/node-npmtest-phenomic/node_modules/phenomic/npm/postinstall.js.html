...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-phenomic/node_modules/phenomic/npm/postinstall.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-phenomic/node_modules/phenomic/npm/postinstall.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-phenomic/node_modules/phenomic/npm/</a> &#187; postinstall.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// ⚠️
...
function prepareOtherNodeModulesFolder() {
  ...
  stat("e2e-tests", function(error, stats) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!error &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >stats.isDirectory())</span> {
<span class="cstat-no" title="statement not covered" >      console.log("ℹ️ Tweaking and installing dependencies for sub-projects")</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      toPrepare.forEach((script) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        console.log("- Preparing "+ script)</span>
<span class="cstat-no" title="statement not covered" >        execSync(babelNode + " scripts/" + script + ".js", spawnOpts)</span>
      })
    }
  })
}
...
&nbsp;
  ...
  // just prepare
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!error &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >stats.isDirectory())</span> {
<span class="cstat-no" title="statement not covered" >    prepareOtherNodeModulesFolder()</span>
...
<span class="cstat-no" title="statement not covered" >    console.log("ℹ️ No .npmignore in phenomic-theme-base to rename")</span>
<span class="cstat-no" title="statement not covered" >    return true</span>
  }
&nbsp;
  fs.move(
